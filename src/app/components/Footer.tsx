...
const Footer = () => {
  return (
    <footer className="bg-gray-800 text-white py-6 fixed w-full bottom-0 z-[1]">
      <div className="container mx-auto flex flex-col md:flex-row justify-center md:gap-20 items-center">
